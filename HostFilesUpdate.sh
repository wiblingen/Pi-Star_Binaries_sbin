...
curl --fail -o ${DMRHOSTS} -s http://www.pistar.jednoduse.cz/downloads/DMR_Hosts.txt --user-agent "Pi-Star_${pistarCurVersion}"
...
curl -sSL http://www.pistar.jednoduse.cz/downloads/DMRIds.dat.gz --user-agent "Pi-Star_${pistarCurVersion}" | gunzip -c > ${DMRIDFILE}
